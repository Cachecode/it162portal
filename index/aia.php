      ...
      <!-- START TABLE -->
        ...
        <table class="clientinfo">
          ...
          <tr>
            ...
            <td>My client's name is Bianca Long, she is my hairstylist and friend, she is the final decision maker.</td>
          ...
          <tr>
            ...
            <td>It will be an identity and marketing website, with information and social networking aspects.</td>

          </tr>

          <tr>
            <td>Client's goal(s) </td>
            <td>My client hopes to gain a presence on the internet for her business in order to market the salons services and gain new clients.</td>
        ...
        <table class="aia">
          ...
          <tr>
            <td><b>Potential Clients:</b>
              ...
              I predict most will use safari on mobile, a large majority of people are using Iphones, But will keep all popular ways of browsing in mind.
            </td>

            <td>
              <b>Potential Clients</b> are looking for a trustworthy, confident, talented and communicative hairstylsit
            ...
            <td><b>How I will get the attention of potential clients</b> is by show them very clearly what they want and need to see if they wish to do buisness with Bloom.
              ...
              <ul>Service rates, and a contact page with a phone number, e-mail address, and contact form.</ul>
            </td>
          ...
          <td><b>Current Clients:</b>
            ...
            keep them in the loop if anything was to change, updates, news, or possible special offers for referrals.
          </td>
          ...
          <td>
          <b>How I will keep the attention of returning clients</b> is by providing updated information and news on anything of importance.
